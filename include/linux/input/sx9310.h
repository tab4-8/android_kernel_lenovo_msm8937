...
#define KEY_KONGKOU_KEYCODE 0x294
...
struct sx93XX 
{
  ...
  int kongkou_irq;  /*add by dingjian for kongkou detection */
  ...
  int vdd_ctrl; /* [P3592] for control vdd by gpio 141 , add by djian 20170123 pm*/
